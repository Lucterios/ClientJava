...
public class SpinEdit extends JComponent  implements ActionListener,FocusListener
{
    /**
	 * 
	 */
    ...
    /**
    * Creates SpinEdit control with upper limit of max integer 
    * value and bottom limit of 0 and start value 0.
    */
    ...
    /**
    * Creates SpinEdit control with upper limit of max integer 
    * value and bottom limit of 0 and given start value .
    *
    ...
    */
    ...
    /**
    * Creates SpinEdit control with given upper limit, bottom
    * limit and start value.
    *
    * @param num start value
    * @param bottomL bottom limit
...
/**
    ...
    */
    ...
    public void setBounds(int x, int y, int width, int height) 
    {
        ...
        downButton.setBounds(fieldWidth, height/2, width-fieldWidth, height/2);
    }
}
