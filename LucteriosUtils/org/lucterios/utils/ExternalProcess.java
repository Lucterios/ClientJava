...
public class ExternalProcess extends Thread
{
	...
	{
		ExternalProcess proc=new ExternalProcess(args[0],args[1]);
		javax.swing.JOptionPane.showMessageDialog(null,"Stop ?","ExternalProcess",javax.swing.JOptionPane.QUESTION_MESSAGE);
		proc.Terminate();
	}
