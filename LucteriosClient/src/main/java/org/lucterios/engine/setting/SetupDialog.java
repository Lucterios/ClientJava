...
public class SetupDialog implements DialogVisitor {
	...
	public void Init() {
		...
		btn_Ok.setImage(Singletons.getWindowGenerator().CreateImage(this.getClass().getResource("/ok.png")));
		...
		btn_Cancel.setImage(Singletons.getWindowGenerator().CreateImage(this.getClass().getResource("/cancel.png")));
		...
		btn_import.setImage(Singletons.getWindowGenerator().CreateImage(this.getClass().getResource("/import.png")));
	}
