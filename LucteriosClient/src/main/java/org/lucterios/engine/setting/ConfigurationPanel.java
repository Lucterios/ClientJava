...
public class ConfigurationPanel implements GUISelectListener {
	class ServerEditor implements DialogVisitor {
		...
		public void InitBtn() {
			...
			btn_AddNew.setImage(Singletons.getWindowGenerator().CreateImage(this.getClass().getResource("/ok.png")));
			...
			btn_ExitNew.setImage(Singletons.getWindowGenerator().CreateImage(this.getClass().getResource("/cancel.png")));
