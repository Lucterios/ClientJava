...
public class FrameTest implements FrameVisitor {
	...
	public void execute(GUIFrame frame) {
		mFrame = frame;
		mFrame.setImage(mFrame.getGenerator().CreateImage(this.getClass().getResource("/LucteriosLogo.png")));
	...
	private void initBtn() {
		...
		bt1.setImage(mFrame.getGenerator().CreateImage(this.getClass().getResource("/new.gif")));
		...
		bt2.setImage(mFrame.getGenerator().CreateImage(this.getClass().getResource("/open.gif")));
		...
		bt3.setImage(mFrame.getGenerator().CreateImage(this.getClass().getResource("/paste.gif")));
