...
public class DialogSimple implements DialogVisitor {
	...
	private void initBtn() {
		...
		bt1.setImage(mDialog.getGenerator().CreateImage(this.getClass().getResource("/new.gif")));
		...
		bt2.setImage(mDialog.getGenerator().CreateImage(this.getClass().getResource("/open.gif")));
		...
		bt3.setImage(mDialog.getGenerator().CreateImage(this.getClass().getResource("/paste.gif")));
	...
	private void initComp() {
		...
		img.setImage(this.getClass().getResource("/warning.png"));
