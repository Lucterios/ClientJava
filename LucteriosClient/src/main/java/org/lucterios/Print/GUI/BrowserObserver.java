...
{  
    ...
    private void initComponents() {
        ...
        treeBrowser.setImagePaths(new URL[]{
        	this.getClass().getResource("/image.png"), //0
        	this.getClass().getResource("/text.png"),  //1
        	this.getClass().getResource("/table.png"), //2
        	this.getClass().getResource("/colonne.png"), //3
        	this.getClass().getResource("/ligne.png"), //4
        	this.getClass().getResource("/cellule.png"), //5
        	this.getClass().getResource("/model.png"), //6
        	this.getClass().getResource("/page.png"), //7
        	this.getClass().getResource("/area.png"), //8
        	this.getClass().getResource("/columns.png"), //9
			this.getClass().getResource("/rows.png"), //10
		    this.getClass().getResource("/vector.png"), //11
        });
