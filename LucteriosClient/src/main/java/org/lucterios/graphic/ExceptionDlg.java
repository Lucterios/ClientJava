...
public class ExceptionDlg {
    ...
    private ExceptionDlg() 
    {
        ...
        lbl_img.setImage(mGenerator.CreateImage(this.getClass().getResource("/error.png")));
    ...
    public AbstractImage getIcon(int aIconType)
    {
		switch(aIconType)
		{
			...
			case LucteriosException.CRITIC:
				return mGenerator.CreateImage(this.getClass().getResource("/error.png"));
			case LucteriosException.GRAVE:
			case LucteriosException.IMPORTANT:
				return mGenerator.CreateImage(this.getClass().getResource("/warning.png"));
			case LucteriosException.MINOR:
				return mGenerator.CreateImage(this.getClass().getResource("/info.png"));
			default:
				return mGenerator.CreateImage(this.getClass().getResource("/error.png"));
		}
